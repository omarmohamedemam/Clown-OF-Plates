...
import eg.edu.alexu.csd.oop.game.examples.object.BarObject;
import eg.edu.alexu.csd.oop.game.examples.object.BubleObject;
import eg.edu.alexu.csd.oop.game.examples.object.CrossObject;
...
public class Bubles implements World{
	...
	public Bubles(int screenWidth, int screenHeight) {
		...
		for(Color color : new Color[] { Color.YELLOW, Color.GREEN, Color.BLUE, Color.CYAN, Color.ORANGE })
